...
const localizenewCommentPopup2 = () => {
  const newCommentPopup = $('#newComment2');
  if (newCommentPopup.length !== 0) commentL10n.localize(newCommentPopup);
};
...
const insertNewCommentPopupIfDontExist2 = function (comment, callback) {
  $('#newComment2').remove();
  ...
  localizenewCommentPopup2();

  return newCommentPopup;
};
const showNewCommentPopup5 = (position) => {
  ...
  // $('#newComment3').css('left', left);
  // if (left === position[0]) {
  //   $('#newComment3').css('top', top);
  // }

  $('#newComment5').addClass('popup-show');

};
const showNewCommentPopup4 = (position) => {
  ...
  console.log(left)
  const top = position[1];
  $('#newComment4').css('left', left + 30);
  if (left === position[0]) {
    $('#newComment4').css('top', top - 20);
  }
  $('#NC4').css('left', left);

  $('#newComment4').addClass('popup-show');

};

const showNewCommentPopup3 = (position) => {
  // position below comment icon
  // position = position || [];
  // let left = position[0];
  // if ($('.toolbar .addComment').length) {
  ...
  $('#newComment3').addClass('popup-show');

};
const showNewCommentPopup2 = (position) => {
  // position below comment icon
  // position = position || [];
  // let left = position[0];
  // if ($('.toolbar .addComment').length) {
  ...
  // }
  // const top = position[1];
  // $('#newComment2').css('left', left);
  // if (left === position[0]) {
  //   $('#newComment2').css('top', top);
  // }

  $('#newComment2').addClass('popup-show');

};
const showNewCommentPopup1 = (position) => {
  // position below comment icon
  console.log("did come here 3")
  position = position || [];
  let left = position[0];
  if(left>=900){ left = 900;position[0] = 900;}
  if ($('.toolbar .addComment').length) {
    left = $('.toolbar .addComment').offset().left;
  }
  const top = position[1];
  ...
  $('#newComment1').css('left', left);
  if (left === position[0]) {
    $('#newComment1').css('top', top);
  }
  $('#newComment1').addClass('popup-show');
...
exports.insertNewCommentPopupIfDontExist2 = insertNewCommentPopupIfDontExist2;
exports.showNewCommentPopup = showNewCommentPopup;
exports.showNewCommentPopup1 = showNewCommentPopup1;
exports.showNewCommentPopup2 = showNewCommentPopup2;
exports.showNewCommentPopup3 = showNewCommentPopup3;
exports.showNewCommentPopup4 = showNewCommentPopup4;
exports.showNewCommentPopup5 = showNewCommentPopup5;
